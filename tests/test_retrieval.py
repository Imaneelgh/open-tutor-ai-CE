...
def _admin_auth(client):
    """First signup → admin."""
    client.post("/auths/signup", json={"email": "admin@ret.com", "name": "Admin", "password": "pass1234!"})
    r = client.post("/api/v1/auths/signin", json={"email": "admin@ret.com", "password": "pass1234!"})
    return {"Authorization": f"Bearer {r.json()['token']}"}


def _user_auth(client):
    """Second signup → regular user."""
    client.post("/auths/signup", json={"email": "user@ret.com", "name": "User", "password": "pass1234!"})
    r = client.post("/api/v1/auths/signin", json={"email": "user@ret.com", "password": "pass1234!"})
    return {"Authorization": f"Bearer {r.json()['token']}"}
...
class TestRetrievalApiV1:
    ...
    def test_update_config_nested(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/config/update",
                        json={
    ...
    def test_update_query_settings(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/query/settings/update",
    ...
    def test_update_embedding(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/embedding/update",
                        json={"embedding_engine": "openai", "embedding_model": "text-embedding-3-small"},
                        headers=h)
        assert r.status_code == 200
    ...
    def test_update_reranking(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/reranking/update",
    ...
    def test_process_file(self, client):
        _admin_auth(client)
        h = _user_auth(client)
        r = client.post("/api/v1/retrieval/process/file",
    ...
    def test_process_youtube(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/process/youtube",
    ...
    def test_process_web(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/process/web",
    ...
    def test_process_web_search(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/process/web/search",
    ...
    def test_query_doc(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/query/doc",
    ...
    def test_query_collection(self, client):
        h = _admin_auth(client)
        r = client.post("/api/v1/retrieval/query/collection",
