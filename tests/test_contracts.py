...
def _signup(client, email="u@test.com", name="U", pwd="pass1234!"):
    r = client.post("/auths/signup", json={"email": email, "name": name, "password": pwd})
...
class TestAuthRoot:
    ...
    def test_signup_root(self, client):
        ...
        r = client.post("/auths/signup", json={
            "email": "signup@test.com", "name": "Alice", "password": "secret123!",
        })
...
class TestAuthApiV1:
    ...
    def test_signin(self, client):
        ...
        _signup(client)
        r = client.post("/api/v1/auths/signin", json={
...
class TestSupportsApiV1:
    ...
    def test_create(self, client):
        ...
        token = _signup(client)
        r = client.post("/api/v1/supports/create",
    ...
    def test_list_with_status_filter(self, client):
        ...
        token = _signup(client)
        r = client.get("/api/v1/supports/list?status=pending", headers=_auth_header(token))
        assert r.status_code == 200

    def test_get_by_id(self, client):
        """GET /api/v1/supports/{id}  ← getSupportById() in supports/index.ts:180"""
        token = _signup(client)
        created = client.post("/api/v1/supports/create",
    ...
    def test_update_chat_id(self, client):
        ...
        token = _signup(client)
        support = client.post("/api/v1/supports/create",
    ...
    def test_delete(self, client):
        ...
        support = client.post("/api/v1/supports/create",
                              ...
                              headers=_auth_header(token)).json()
        r = client.delete(f"/api/v1/supports/{support['id']}", headers=_auth_header(token))
        assert r.status_code == 200
...
class TestSelfRegulationApiV1:
    ...
    def test_update_config(self, client):
        ...
        token = _signup(client)
        r = client.post("/api/v1/self_regulation/config",
                        json={"enabled": True},
                        headers=_auth_header(token))
        assert r.status_code == 200
    ...
    def test_get_all_feedbacks(self, client):
        ...
        token = _signup(client)
        r = client.get("/api/v1/self_regulation/feedbacks/all", headers=_auth_header(token))
        assert r.status_code == 200
        assert isinstance(r.json(), list)
    ...
    def test_export_feedbacks(self, client):
        ...
        token = _signup(client)
        r = client.get("/api/v1/self_regulation/feedbacks/all/export", headers=_auth_header(token))
        assert r.status_code == 200

    def test_create_feedback(self, client):
        """POST /api/v1/self_regulation/feedback  ← createNewFeedback() in evaluations/index.ts:130"""
        token = _signup(client)
        r = client.post("/api/v1/self_regulation/feedback",
    ...
    def test_get_feedback_by_id(self, client):
        ...
        token = _signup(client)
        fb = client.post("/api/v1/self_regulation/feedback",
                         json={"data": {"rating": "neutral"}},
                         headers=_auth_header(token)).json()
        r = client.get(f"/api/v1/self_regulation/feedback/{fb['id']}", headers=_auth_header(token))
        assert r.status_code == 200
    ...
    def test_update_feedback(self, client):
        ...
        fb = client.post("/api/v1/self_regulation/feedback",
                         json={"data": {"rating": "neutral"}},
                         headers=_auth_header(token)).json()
        r = client.post(f"/api/v1/self_regulation/feedback/{fb['id']}",
    ...
    def test_delete_feedback(self, client):
        ...
        fb = client.post("/api/v1/self_regulation/feedback",
                         ...
                         headers=_auth_header(token)).json()
        r = client.delete(f"/api/v1/self_regulation/feedback/{fb['id']}", headers=_auth_header(token))
        assert r.status_code == 200
